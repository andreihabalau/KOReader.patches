...
for _, item in ipairs { "frontlight", "frontlight_warmth", "mem_usage" } do
    symbol_prefix.compact_items[item] = symbol_prefix.icons[item]
end

-- replace chapter time to read compact icon with single > or <
symbol_prefix.compact_items["chapter_time_to_read"] = symbol_prefix.compact_items["pages_left"]
